...
class IncrementalJvmCompilerRunner(
        ...
        for (javaFile in javaFiles) {
            if (!caches.platformCache.isTrackedFile(javaFile)) {
                ...
                for (psiClass in psiFile.classes) {
                    ...
                    caches.processChangedUntrackedJavaClass(psiClass, ClassId.topLevel(FqName(qualifiedName)))
                }
            }
        }
    ...
    private fun IncrementalJvmCachesManager.processChangedUntrackedJavaClass(psiClass: PsiClass, classId: ClassId) {
        addChangedUntrackedJavaClass(classId)
    ...
    override fun makeServices(
        ...
        super.makeServices(args, lookupTracker, caches, compilationMode).apply {
            ...
            if (usePreciseJavaTracking) {
                val changesTracker = JavaClassesTrackerImpl(caches.platformCache, caches.getAndClearUntrackedJavaClasses())
